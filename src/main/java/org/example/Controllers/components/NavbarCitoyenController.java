...
import org.example.Controllers.association.DonationIndexClientController;
...
public class NavbarCitoyenController {
    ...
    @FXML
    void goToBlogs() {
        navigate("/annonces/list_annonces_user.fxml", "Annonces");
    }
    ...
    void goToDonations() {
        ...
        if (loggedUser == null) {
            System.out.println("User NULL -> cannot open donations");
            return;
        }

        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/donation/donationIndexClient.fxml")
            );
            ...
            // ✅ IMPORTANT : inject user BEFORE scene change logic
